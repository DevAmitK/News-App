...
import com.example.newstoday.Screens.SearchBar
...
fun Home(viewModel: NewsViewModel, navController: NavHostController) {
            ...
            ModalDrawerSheet(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Version 1.0.0", modifier = Modifier.padding(start = 8.dp)
                        )
                    }
                }
    ...
    if (openAboutMeBottomSheet) {
        Toast.makeText(LocalContext.current, "About Me", Toast.LENGTH_SHORT).show()
    }
