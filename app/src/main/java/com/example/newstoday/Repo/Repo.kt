...
class Repo {
    ...
    suspend fun newsProvider(category: String?, query: String?,country : String?) : Response<NewsModel>{

        return if (query.isNullOrEmpty()){
            API_Builder.provideAPI().getAllNews(category = category, country = country )
        }else{
